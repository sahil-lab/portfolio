...
export function ResumeContent(){return <article className="resume-record">
 ...
 <h3>Skills</h3><dl>{resume.skills.map(s=><div key={s.category}><dt>{s.category}</dt><dd>{s.items}</dd></div>)}</dl>
