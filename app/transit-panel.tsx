...
export function TransitPanel({status,start,hub,arrive,bulletins,observe}:{status:TransitStatus;start:(destination:number,mode:TransitMode)=>void;hub:()=>void;arrive:()=>void;bulletins?:(kind:'markets'|'news')=>void;observe?:(destination:number)=>void}){
